...
<meta charset="UTF-8">
        ...
        <meta name="author" content="derrick Munezero">
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bulma/0.7.4/css/bulma.min.css">
    <script defer src="https://use.fontawesome.com/releases/v5.3.1/js/all.js"></script>
    <script src='https://kit.fontawesome.com/a076d05399.js'></script>
        <title>COOL</title>        
       <!-- <link href="../dizzo12/css/bulma.css" rel="stylesheet" type="text/css"/> -->
       <!-- <link href="../sass/app.scss" rel="stylesheet" type="text/css"/> -->
       <!-- <link href="../sass/app.scss" rel="stylesheet/scss" type="text/css">
